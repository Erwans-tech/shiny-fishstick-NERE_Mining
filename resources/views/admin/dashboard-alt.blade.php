...
<body>
    <div class="header">
        ...
        <p>Dashboard Diagnostic ({{ $stats['app_env'] }} - {{ $stats['session_driver'] }})</p>
        <p>Connecté en tant que: <strong>{{ $stats['admin_user'] }}</strong></p>
    </div>
    ...
    <div class="container">
        ...
        <div class="card">
            ...
            <div class="stats">
                ...
                <div class="stat">
                    <div class="stat-number">{{ $stats['jobs_count'] }}</div>
