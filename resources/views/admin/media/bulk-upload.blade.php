...
@section('title', 'Upload Multiple d\'Images')
@section('page-title', 'Upload Multiple')
...
<form method="POST" action="{{ route('admin.media.bulk.store') }}" enctype="multipart/form-data" id="bulk-upload-form">
    @csrf
