        ...
        <div class="content">
            ...
            <div class="field-group">
                ...
                <div class="field-value">
                    <a href="mailto:{{ $message->email }}" style="color: #d72f2f; text-decoration: none;">
                        {{ $message->email }}
                    </a>
                </div>
            </div>
            ...
            <div class="field-group">
                ...
                <div class="field-value">{{ $message->type }}</div>
            </div>
            
            <div class="field-group">
                <div class="field-label">Date de réception</div>
                <div class="field-value">{{ $message->created_at->format('d/m/Y à H:i') }}</div>
            </div>
            ...
            <div class="reply-info">
                <strong>💡 Pour répondre :</strong> Répondez directement à cet e-mail, votre réponse sera envoyée à {{ $message->name }} ({{ $message->email }}).
            </div>
            
            <div style="text-align: center;">
                <a href="{{ config('app.url') }}/admin/messages/{{ $message->id }}" class="admin-link">
                    👁️ Voir dans l'admin
                </a>
            </div>
        </div>
