...
<style>
    ...
    .future-crawler-label { position:absolute; left:50%; bottom:58px; transform:translateX(-50%); color:#ffc247; font:700 8px/1 Inter,sans-serif; letter-spacing:.12em; text-transform:uppercase; white-space:nowrap; }
...
<section id="modele-operationnel" class="sand">
    ...
    <div class="future-steps" role="list">
        <div class="future-crawler" aria-hidden="true" data-machine="excavation"
            ...
            <span class="future-crawler-label">CATERPILLAR</span>
