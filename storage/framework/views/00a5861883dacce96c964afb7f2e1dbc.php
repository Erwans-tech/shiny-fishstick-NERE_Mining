...
<section class="sa-animated-section" style="padding-top:40px;">
    ...
    <div class="reserves-hero">
        ...
        <img class="sa-reveal sa-delay-2" src="<?php echo e(asset('images/mining/karma-05.jpg')); ?>"
        ...
        <div class="reserves-table-wrapper" style="margin-top:40px;">
            ...
            <div>
                <div class="sa-program-card sa-reveal sa-delay-2" style="margin-bottom:16px;">
                    <h3 style="text-align:left; color:var(--green); margin-bottom:12px; font-size:16px; font-weight:600;"><?php echo e($en ? 'Key Resources' : 'Ressources Clés'); ?></h3>
                ...
                <div class="sa-partner-card sa-reveal sa-delay-3" style="border-left:4px solid var(--green);">
                    <h4 style="text-align:left; color:var(--green); margin:0 0 12px 0; font-size:14px; font-weight:600;"><?php echo e($en ? 'Major Deposits' : 'Gisements Majeurs'); ?></h4>
                    <ul class="sa-animated-list">
                        <li><span class="sa-list-bullet" style="font-size:11px;">•</span><span style="font-size:13px; color:var(--muted);"><strong>Kao Main:</strong> <?php echo e($en ? '26,901 Kt at 0.84 g/t' : '26 901 Kt à 0,84 g/t'); ?></span></li>
                        <li><span class="sa-list-bullet" style="font-size:11px;">•</span><span style="font-size:13px; color:var(--muted);"><strong>GG2:</strong> <?php echo e($en ? '14,316 Kt at 1.31 g/t' : '14 316 Kt à 1,31 g/t'); ?></span></li>
                        <li><span class="sa-list-bullet" style="font-size:11px;">•</span><span style="font-size:13px; color:var(--muted);"><strong>Kao Nord:</strong> <?php echo e($en ? '12,024 Kt at 1.16 g/t' : '12 024 Kt à 1,16 g/t'); ?></span></li>
                        <li><span class="sa-list-bullet" style="font-size:11px;">•</span><span style="font-size:13px; color:var(--muted);"><strong>GG1:</strong> <?php echo e($en ? '4,971 Kt at 0.72 g/t' : '4 971 Kt à 0,72 g/t'); ?></span></li>
                    </ul>
                </div>
            </div>
        </div>
...
<section class="sa-sand-animated" style="position:relative; padding:70px 5vw;">
    ...
    <div style="position:relative; z-index:1; max-width:1180px; margin:0 auto;">
        ...
        <p class="sa-reveal sa-delay-1" style="color:var(--muted); font-size:14px; line-height:1.8; margin:24px auto 40px auto; text-align:center; max-width:800px;"><?php echo e($en ? 'Inferred mineral resources are estimated based on limited geological evidence and sampling. They represent mineralization that is beyond the limits of reasonable assumption but may become included in reserves as exploration and development activities continue.' : 'Les ressources minérales inférées sont estimées sur la base de données géologiques et d\'échantillonnage limités. Elles représentent une minéralisation au-delà des limites d\'une hypothèse raisonnable mais peuvent devenir incluses dans les réserves à mesure que les activités d\'exploration et de développement se poursuivent.'); ?></p>
        ...
        <div class="stat-band sa-reveal sa-delay-2" style="margin-bottom:0;">
            <div class="stat-item sa-stat-item-enhanced">
                ...
                <span class="stat-label"><?php echo e($en ? 'Total Inferred' : 'Total Inféré'); ?> (Kt)</span>
            </div>
            <div class="stat-item sa-stat-item-enhanced">
                <span class="stat-value" data-count="1.25" data-original="1.25">1.25</span>
                <span class="stat-label"><?php echo e($en ? 'Average Grade' : 'Teneur Moyenne'); ?> (g/t)</span>
            </div>
            <div class="stat-item sa-stat-item-enhanced">
                <span class="stat-value" data-count="725" style="color:var(--gold);" data-original="725">725</span>
                <span class="stat-label"><?php echo e($en ? 'Gold Content' : 'Contenu Or'); ?> (Koz)</span>
            </div>
        </div>
    </div>
    <div class="sa-wave-bottom"></div>
    ...
    <div style="max-width:1180px; margin:0 auto;">
        ...
        <div class="grid-2" style="margin-top:40px;">
            <div class="sa-program-card sa-reveal sa-delay-1">
                <h4 style="text-align:left; color:var(--green); margin:0 0 12px 0; font-size:16px; font-weight:600;"><?php echo e($en ? 'Ore Reserves' : 'Réserves de Minerai'); ?></h4>
                <p style="text-align:left; color:var(--muted); font-size:14px; line-height:1.7; margin:0;"><?php echo e($en ? 'Mineralization that is economically extractable, based on reasonable mining assumptions and detailed resource/reserve estimates.' : 'Minéralisation économiquement exploitable, basée sur des hypothèses minières raisonnables et des estimations détaillées des ressources/réserves.'); ?></p>
            </div>

            <div class="sa-program-card sa-reveal sa-delay-2">
                <h4 style="text-align:left; color:var(--green); margin:0 0 12px 0; font-size:16px; font-weight:600;"><?php echo e($en ? 'Measured Resources' : 'Ressources Mesurées'); ?></h4>
                <p style="text-align:left; color:var(--muted); font-size:14px; line-height:1.7; margin:0;"><?php echo e($en ? 'Estimates where confidence in geological and grade continuity is high, based on detailed sampling and geological mapping.' : 'Estimations avec confiance élevée en la continuité géologique et de la teneur, basées sur l\'échantillonnage et le levé géologique détaillés.'); ?></p>
            </div>

            <div class="sa-program-card sa-reveal sa-delay-3">
                <h4 style="text-align:left; color:var(--green); margin:0 0 12px 0; font-size:16px; font-weight:600;"><?php echo e($en ? 'Indicated Resources' : 'Ressources Indiquées'); ?></h4>
            ...
            <div class="sa-program-card sa-reveal sa-delay-4">
                <h4 style="text-align:left; color:var(--green); margin:0 0 12px 0; font-size:16px; font-weight:600;"><?php echo e($en ? 'Inferred Resources' : 'Ressources Inférées'); ?></h4>
