...
<body>
<div class="box">
    <img class="box-logo" src="<?php echo e(asset('images/logo-nere.png')); ?>" alt="Néré Mining">
    ...
    <form method="POST" action="<?php echo e(route('admin.login.post')); ?>" autocomplete="off">
        <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\erwan\OneDrive\Bureau\REFONTESITE\resources\views/admin/login.blade.php ENDPATH**/ ?>