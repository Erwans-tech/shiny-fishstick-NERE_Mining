...
<div id="cookie-banner" class="cookie-banner" aria-live="polite" style="display:none;">
    <div class="cookie-banner__inner">
        <div class="cookie-banner__content">
            <div class="cookie-banner__title"><?php echo e($cookieEnglish ? 'Cookie preferences' : 'Gestion des cookies'); ?></div>
            <p>
                <?php echo e($cookieEnglish
        ...
        <div class="cookie-banner__actions">
            <a href="<?php echo e($cookieEnglish ? route('english.cookies.policy') : route('cookies.policy')); ?>" class="cookie-banner__link"><?php echo e($cookieEnglish ? 'Learn more' : 'En savoir plus'); ?></a>
            <button type="button" class="cookie-banner__btn cookie-banner__btn--secondary" data-cookie-action="reject">
                <?php echo e($cookieEnglish ? 'Refuse' : 'Refuser'); ?>

            </button>
            <button type="button" class="cookie-banner__btn cookie-banner__btn--primary" data-cookie-action="accept">
                <?php echo e($cookieEnglish ? 'Accept' : 'Accepter'); ?>
...
<?php /**PATH C:\Users\erwan\OneDrive\Bureau\REFONTESITE\resources\views\partials\cookie-banner.blade.php ENDPATH**/ ?>