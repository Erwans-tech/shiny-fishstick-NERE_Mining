...
<section id="presentation">
    <h2><?php echo e(__('site.karma_pres_h2', [], $loc)); ?></h2>
    <p class="lead"><?php echo e(__('site.karma_pres_lead', [], $loc)); ?></p>

    <div class="grid-2" style="margin-bottom:40px;">
        <div>
            <div class="card" style="margin-bottom:20px;">
                <h4><?php echo e(__('site.karma_history_h4', [], $loc)); ?></h4>
                <p><?php echo e(__('site.karma_history_p', [], $loc)); ?></p>
            </div>
            <div class="card" style="margin-bottom:20px;">
                <h4><?php echo e(__('site.karma_loc_h4', [], $loc)); ?></h4>
                <p><?php echo nl2br(e(__('site.karma_loc_p', [], $loc))); ?></p>
            </div>
            <div class="card">
                <h4><?php echo e(__('site.karma_area_h4', [], $loc)); ?></h4>
...
<section id="exploitation" class="sand">
    ...
    <div class="stat-band">
        <div class="stat-item"><span class="stat-value">97 koz</span><span class="stat-label"><?php echo e($en ? 'Annual average (2019-2021)' : "Production annuelle moyenne (2019-2021)"); ?></span></div>
        <div class="stat-item"><span class="stat-value">949 koz</span><span class="stat-label"><?php echo e($en ? 'Total gold reserves' : 'Réserves or totales'); ?></span></div>
        <div class="stat-item"><span class="stat-value">33.2 Mt</span><span class="stat-label"><?php echo e($en ? 'Ore reserves' : 'Réserves minerai'); ?></span></div>
...
<section id="production-timeline">
    ...
    <p class="lead" style="text-align:center; margin-bottom:32px;"><?php echo e($en ? 'Karma mine history from 2007 to present' : 'Historique de la mine de Karma de 2007 à nos jours'); ?></p>
    ...
    <div style="background:#fff; padding:24px; border:1px solid var(--line); border-radius:8px;">
        <h3 style="color:var(--green); margin:0 0 12px 0; font-size:16px; font-weight:600;"><?php echo e($en ? 'Key Milestones' : 'Jalons Clés'); ?></h3>
        <ul style="list-style:none; padding:0; margin:0; font-size:14px; line-height:1.8; color:var(--muted);">
            <li style="margin-bottom:12px;">✓ <?php echo e($en ? '2007: Acquired Goulagou and Rounga properties (487 km²)' : '2007: Acquisition des propriétés Goulagou et Rounga (487 km²)'); ?></li>
            <li style="margin-bottom:12px;">✓ <?php echo e($en ? '2019: Commenced gold production at 80 Koz annually' : '2019: Démarrage production or à 80 Koz annuels'); ?></li>
            <li style="margin-bottom:12px;">✓ <?php echo e($en ? '2024: Transition to Burkinabè-majority ownership (Néré Mining)' : '2024: Transition vers majorité actionnaire burkinabè (Néré Mining)'); ?></li>
            <li>✓ <?php echo e($en ? '2026+: CIL plant commissioning for refractory ore processing' : '2026+: Mise en service usine CIL pour traitement minerai réfractaire'); ?></li>
        </ul>
    </div>
</section>
...
<section id="ressources" class="sand">
    ...
    <p class="lead" style="text-align:center; margin-bottom:32px;"><?php echo e($en ? 'JORC-classified mineral resources across five major deposits at Karma' : 'Ressources minérales classifiées JORC dans cinq gisements majeurs'); ?></p>
    ...
    <div style="display:grid; grid-template-columns:1fr 1fr; gap:28px; align-items:start; margin-bottom:48px;">
            ...
            <table style="width:100%; border-collapse:collapse; font-size:13px; line-height:1.6;">
                <thead>
                    <tr style="background:linear-gradient(135deg, var(--green), var(--gold)); color:#fff;">
                        <th style="padding:14px; text-align:left; font-weight:600;"><?php echo e($en ? 'Deposit' : 'Gisement'); ?></th>
                ...
                <tbody>
                    ...
                    <tr style="background:var(--light); font-weight:600; border-top:2px solid var(--green);">
                        <td style="padding:12px 14px;"><?php echo e($en ? 'Total' : 'Total'); ?></td>
        ...
        <div>
            <div style="background:#fff; padding:20px; border-radius:8px; border:1px solid var(--line); margin-bottom:16px;">
                <h3 style="color:var(--green); margin-bottom:12px; font-size:16px; font-weight:600;"><?php echo e($en ? 'Resource Overview' : 'Vue d\'Ensemble des Ressources'); ?></h3>
            ...
            <div style="background:var(--light); padding:16px; border-radius:6px; border-left:4px solid var(--green);">
                <h4 style="color:var(--green); margin:0 0 12px 0; font-size:14px; font-weight:600;"><?php echo e($en ? 'Classification' : 'Classification'); ?></h4>
                <ul style="list-style:none; padding:0; margin:0; font-size:13px; line-height:1.8; color:var(--muted);">
                    <li>• <?php echo e($en ? 'Measured Resources: High confidence deposits' : 'Ressources Mesurées: Gisements haute confiance'); ?></li>
                    <li>• <?php echo e($en ? 'Indicated Resources: Established geological continuity' : 'Ressources Indiquées: Continuité géologique établie'); ?></li>
                    <li>• <?php echo e($en ? 'Inferred Resources: Limited geological evidence' : 'Ressources Inférées: Preuves géologiques limitées'); ?></li>
                </ul>
            </div>
        </div>
    </div>
...
<section id="organisation">
    ...
    <div class="grid-3">
        ...
        <div class="card">
            ...
            <h3><?php echo e(__('site.karma_dept'.$i.'_h3', [], $loc)); ?></h3>
...
<section id="modele-operationnel" class="sand">
    ...
    <div class="steps" style="border:1px solid var(--line); border-radius:8px; overflow:hidden; background:#fff; margin-bottom:40px;">
        ...
        <div class="step">
            <div class="step-num">0<?php echo e($i); ?></div>
            <h4><?php echo e(__('site.karma_step'.$i.'_h4', [], $loc)); ?></h4>
            <p><?php echo e(__('site.karma_step'.$i.'_p', [], $loc)); ?></p>
        </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </div>
</section>
    ...
    <div class="grid-2">
        <div>
            ...
            <div class="card karma-impact-card" style="margin-bottom:18px;">
                ...
                <p><?php echo e(__('site.karma_imp_job'.$i.'_p', [], $loc)); ?></p>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
        <div>
            ...
            <div class="card karma-impact-card" style="margin-bottom:18px;">
                ...
                <p><?php echo e(__('site.karma_imp_eco'.$i.'_p', [], $loc)); ?></p>
            </div>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
    </div>
