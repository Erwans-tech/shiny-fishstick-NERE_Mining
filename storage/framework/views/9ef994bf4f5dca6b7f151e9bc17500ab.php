...
<aside class="sidebar" id="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="<?php echo e(route('admin.news.index')); ?>"
           class="nav-item <?php echo e(request()->routeIs('admin.news.*') ? 'active' : ''); ?>">
        ...
        <a href="<?php echo e(route('admin.press.index')); ?>"
           class="nav-item <?php echo e(request()->routeIs('admin.press.*') ? 'active' : ''); ?>">
            <span class="nav-icon">📢</span> Communiqués
        </a>
        <a href="<?php echo e(route('admin.media.index')); ?>"
           class="nav-item <?php echo e(request()->routeIs('admin.media.*') ? 'active' : ''); ?>">
            <span class="nav-icon">🖼️</span> Médiathèque
        </a>

        <div class="nav-section">Recrutement</div>
        <a href="<?php echo e(route('admin.jobs.index')); ?>"
           class="nav-item <?php echo e(request()->routeIs('admin.jobs.*') ? 'active' : ''); ?>">
            <span class="nav-icon">💼</span> Offres d'emploi
        </a>
        <?php $newApps = \App\Models\JobApplication::where('status','new')->whereNull('read_at')->count(); ?>
        <a href="<?php echo e(route('admin.applications.index')); ?>"
           class="nav-item <?php echo e(request()->routeIs('admin.applications.*') ? 'active' : ''); ?>">
            ...
            <?php if($newApps > 0): ?>
                <span class="nav-badge"><?php echo e($newApps); ?></span>
            <?php endif; ?>
        </a>
        ...
        <a href="<?php echo e(route('admin.newsletter.index')); ?>"
           class="nav-item <?php echo e(request()->routeIs('admin.newsletter.*') ? 'active' : ''); ?>">
            <span class="nav-icon">📧</span> Newsletter
        </a>

        <div class="nav-section">Karma</div>
        <a href="<?php echo e(route('admin.karma-departments.index')); ?>"
           class="nav-item <?php echo e(request()->routeIs('admin.karma-departments.*') ? 'active' : ''); ?>">
            <span class="nav-icon">🗂️</span> Organigramme
        </a>

        <div class="nav-section">Site public</div>
        <a href="<?php echo e(route('admin.hero.index')); ?>"
           class="nav-item <?php echo e(request()->routeIs('admin.hero.*') ? 'active' : ''); ?>">
            <span class="nav-icon">🎠</span> Carrousel Hero
        </a>
        <a href="<?php echo e(route('admin.certifications.index')); ?>"
           class="nav-item <?php echo e(request()->routeIs('admin.certifications.*') ? 'active' : ''); ?>">
    ...
    <div class="sidebar-footer">
        <div class="sidebar-user">
            ...
            <div>
                <div class="sidebar-user-name"><?php echo e(session('admin_name', 'Admin')); ?></div>
    ...
    <header class="topbar">
        <div class="topbar-left">
            <div class="topbar-breadcrumb">
                ...
                <span><?php echo $__env->yieldContent('page-title', 'Administration'); ?></span>
            </div>
        </div>
        <div class="topbar-right">
            <?php $totalAlerts = \App\Models\ContactMessage::whereNull('read_at')->count() + \App\Models\JobApplication::where('status','new')->whereNull('read_at')->count(); ?>
            <a href="<?php echo e(route('admin.messages.index')); ?>" class="topbar-notif" title="Messages non lus">
                ✉️
                <?php if($totalAlerts > 0): ?><span class="topbar-notif-dot"></span><?php endif; ?>
            </a>
            <span class="topbar-date"><?php echo e(now()->isoFormat('dddd D MMM Y')); ?></span>
            <a href="<?php echo e(url('/')); ?>" target="_blank" class="topbar-site">
                🌐 Voir le site
            </a>
        </div>
    </header>
...
<?php echo $__env->make('partials.emoji-icons', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
</body>
</html>
<?php /**PATH C:\Users\erwan\OneDrive\Bureau\REFONTESITE\resources\views/admin/partials/layout.blade.php ENDPATH**/ ?>