    ...
    <style>
        ...
        *,*::before,*::after { box-sizing:border-box; margin:0; padding:0; }
        ...
        @keyframes heroSlide<?php echo e($index); ?> {
            0%,<?php echo e(max(0, $index * $heroSlot - 2)); ?>% { opacity:0; transform:scale(1.07); }
            <?php echo e(min(100, $index * $heroSlot + 2)); ?>%,<?php echo e(min(100, ($index + 1) * $heroSlot - 2)); ?>% { opacity:1; transform:scale(1.01); }
            <?php echo e(min(100, ($index + 1) * $heroSlot)); ?>%,100% { opacity:0; transform:scale(1); }
        }
...
<body>
    ...
    <section class="hero" aria-label="<?php echo e($en ? 'Homepage hero' : 'Bannière principale'); ?>">
        ...
        <div class="hero-body">
            ...
            <div>
                <h1 class="hero-h1"><?php echo nl2br(e(__('site.home_h1', [], $loc))); ?></h1>
                <p class="hero-intro"><?php echo e(__('site.home_intro', [], $loc)); ?></p>
                <div class="hero-ctas">
                    <a class="btn btn-gold"
                       href="<?php echo e($en ? route('english.karma') : route('karma')); ?>">
                        <?php echo e(__('site.home_cta_karma', [], $loc)); ?>

                    </a>
                    <a class="btn btn-ghost"
                       href="<?php echo e($en ? route('english.sustainability') : route('sustainability')); ?>">
                        <?php echo e(__('site.home_cta_rse', [], $loc)); ?>
        ...
        <div class="intro-inner">
            <div class="intro-copy">
                <div class="intro-brand">
                    <img src="<?php echo e(asset('images/logo-nere.png')); ?>" alt="Néré Mining" loading="eager">
                </div>
    ...
    <section class="sec partners-sec" id="partenaires" aria-labelledby="partners-h">
        ...
        <div class="partners-strip" role="list">
            ...
            <?php $tag = $p['url'] ? 'a' : 'div'; $href = $p['url'] ? 'href="'.e($p['url']).'" target="_blank" rel="noopener noreferrer"' : ''; ?>
            <<?php echo e($tag); ?> <?php echo e($href); ?> class="partner-logo-item" role="listitem">
                <img class="partner-logo-img"
