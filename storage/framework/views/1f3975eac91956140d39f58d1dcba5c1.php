...
<div class="analytics-container">
    ...
    <div class="analytics-header">
        ...
        <div class="header-actions">
            ...
            <div class="action-group">
                <a href="<?php echo e(route('admin.analytics.export', ['days' => $days, 'format' => 'csv'])); ?>" class="btn-action btn-export" title="Exporter en CSV">
                    <span>📥 Export CSV</span>
                </a>
                <a href="<?php echo e(route('admin.analytics.export', ['days' => $days, 'format' => 'json'])); ?>" class="btn-action btn-export" title="Exporter en JSON">
        ...
        <div class="kpi-grid">
            ...
            <div class="kpi-card kpi-primary">
                ...
                <div class="kpi-body">
                    ...
                    <?php if($visitsChange !== null): ?>
                        <div class="kpi-trend <?php echo e($visitsChange >= 0 ? 'trend-up' : 'trend-down'); ?>">
                            <?php echo e($visitsChange >= 0 ? '↑' : '↓'); ?> <?php echo e(abs($visitsChange)); ?>% vs période précédente
                        </div>
                    <?php else: ?>
            ...
            <div class="kpi-card kpi-secondary">
                ...
                <div class="kpi-body">
                    ...
                    <div class="kpi-value"><?php echo e(number_format($uniqueVisitors)); ?></div>
                    <div class="kpi-meta"><?php echo e($uniqueVisitors > 0 ? round(($uniqueVisitors / $totalVisits) * 100, 1) : 0); ?>% du total</div>
                </div>
            </div>
            ...
            <div class="kpi-card kpi-tertiary">
                ...
                <div class="kpi-body">
                    ...
                    <div class="kpi-value"><?php echo e(number_format($visitsToday)); ?></div>
                    <div class="kpi-meta"><?php echo e(now()->locale('fr')->isoFormat('dddd D MMMM')); ?></div>
                </div>
            </div>
            ...
            <div class="kpi-card kpi-quaternary">
                ...
                <div class="kpi-body">
                    ...
                    <div class="kpi-value"><?php echo e($avgPagesPerVisit); ?></div>
            ...
            <div class="kpi-card kpi-quinary">
                ...
                <div class="kpi-body">
                    ...
                    <div class="kpi-value"><?php echo e($bounceRate); ?>%</div>
                    <?php if($bounceRateChange !== null): ?>
                        <div class="kpi-trend <?php echo e($bounceRateChange <= 0 ? 'trend-up' : 'trend-down'); ?>">
                            <?php echo e($bounceRateChange < 0 ? '↓' : '↑'); ?> <?php echo e(abs($bounceRateChange)); ?>% vs période précédente
                        </div>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <div class="kpi-card kpi-senary">
                ...
                <div class="kpi-body">
                    ...
                    <div class="kpi-value"><?php echo e(number_format($recurringVisitors)); ?></div>
                    <div class="kpi-meta"><?php echo e($recurringRate); ?>% de retour</div>
                </div>
            </div>
        </div>
    </section>
    ...
    <div class="graphs-section">
        ...
        <div class="chart-panel">
            <div class="chart-header">
                <div>
                    ...
                    <p class="chart-subtitle">Tendance sur <?php echo e($days); ?> jours</p>
                </div>
                <span class="chart-badge"><?php echo e($thisWeekVisits); ?> cette semaine</span>
            </div>
        ...
        <div class="chart-panel">
            <div class="chart-header">
                ...
                <span class="chart-badge"><?php echo e(array_sum(array_column($devices, 'count'))); ?> total</span>
            </div>
            <div class="chart-container">
        ...
        <div class="chart-panel">
            <div class="chart-header">
                ...
                <span class="chart-badge"><?php echo e($referrers->count()); ?> sources</span>
            </div>
            <div class="chart-container">
    ...
    <div class="data-panels-grid">
            ...
            <div class="panel-content">
                <?php if($topPages->count()): ?>
                    <div class="pages-list">
                        <?php $__currentLoopData = $topPages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $page): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="page-item">
                            <div class="page-rank"><?php echo e($index + 1); ?></div>
                            <div class="page-info">
                                <div class="page-url" title="<?php echo e($page['url']); ?>"><?php echo e($page['url']); ?></div>
                                <div class="page-bar">
                                    <div class="page-bar-fill" style="width: <?php echo e($totalVisits > 0 ? round(($page['visits'] / $totalVisits) * 100, 1) : 0); ?>%"></div>
                                </div>
                            </div>
                            <div class="page-stats">
                                <div class="page-visits"><?php echo e(number_format($page['visits'])); ?></div>
                                <div class="page-percent"><?php echo e($totalVisits > 0 ? round(($page['visits'] / $totalVisits) * 100, 1) : 0); ?>%</div>
                            </div>
                        </div>
        ...
        <div class="data-panel">
            <div class="panel-header">
                ...
                <span class="panel-count">Total: <?php echo e(number_format($uniqueVisitors)); ?></span>
            </div>
            <div class="panel-content">
                <div class="devices-list">
                    <?php $__currentLoopData = ['desktop' => ['icon' => '🖥️', 'label' => 'Desktop'], 'mobile' => ['icon' => '📱', 'label' => 'Mobile'], 'tablet' => ['icon' => '💻', 'label' => 'Tablette']]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $device): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="device-row">
                        <div class="device-header">
                            <span class="device-icon"><?php echo e($device['icon']); ?></span>
                            <div class="device-meta">
                                <span class="device-label"><?php echo e($device['label']); ?></span>
                                <span class="device-count"><?php echo e(number_format($devices[$key]['count'])); ?> visites</span>
                            </div>
                        </div>
                        <div class="device-percent"><?php echo e($devices[$key]['percent']); ?>%</div>
                        <div class="device-bar">
                            <div class="device-fill" style="width: <?php echo e($devices[$key]['percent']); ?>%"></div>
                        </div>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            ...
            <div class="panel-content">
                <?php if($referrers->count()): ?>
                    <div class="sources-list">
                        <?php $__currentLoopData = $referrers->take(8); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ref): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="source-item">
                            <div class="source-info">
                                <span class="source-icon"><?php echo e($ref['source'] === 'Direct' ? '🔗' : '🌐'); ?></span>
                                <span class="source-name"><?php echo e(Str::limit($ref['source'], 28, '…')); ?></span>
                            </div>
                            <div class="source-stat"><?php echo e(number_format($ref['visits'])); ?></div>
                        </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                <?php else: ?>
        ...
        <div class="data-panel">
            ...
            <div class="panel-content">
                <div class="peak-hours-grid">
                    ...
                    <div class="peak-hour" title="<?php echo e($hour['count']); ?> visites à <?php echo e($hour['hour']); ?>">
                        <div class="peak-bar">
                            <div class="peak-fill" style="height: <?php echo e($peakHours->max('count') > 0 ? ($hour['count'] / $peakHours->max('count')) * 100 : 0); ?>%"></div>
                        </div>
                        <div class="peak-label"><?php echo e($hour['hour']); ?></div>
                    </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </div>
            </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (devicesCtx) {
        const devices = <?php echo json_encode($devices, 15, 512) ?>;
    ...
    if (referrersCtx) {
        const referrers = <?php echo json_encode($referrers->take(8), 15, 512) ?>;
