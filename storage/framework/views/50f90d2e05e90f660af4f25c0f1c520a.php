...
<head>
    ...
    <style>
        ...
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
        ...
        /* ── Masthead ── */
        .masthead{padding:100px 5vw 80px;color:#fff;background:linear-gradient(100deg,rgba(75,23,22,.96) 45%,rgba(75,23,22,.55)),url('<?php echo e(asset('images/mining/karma-04.jpg')); ?>') center/cover;}
...
<main>
    ...
    <section>
        ...
        <div class="why-grid">
            ...
            <div class="why-card">
                <div class="why-num">0<?php echo e($i); ?></div>
    ...
    <section style="padding-top:0;padding-bottom:40px;">
        <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:1px;background:var(--line);border:1px solid var(--line);border-radius:8px;overflow:hidden;">
            <?php $__currentLoopData = [['1200+','Emplois directs & indirects','Direct &amp; indirect jobs'],['80%',"Main-d'œuvre burkinabè",'Burkinabe workforce'],['100%','Recrutement local prioritaire','Local-first recruitment'],['0','Coût de dossier','Application fee']]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as [$v,$fr,$en_label]): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<div class="filter-bar">
    <form method="GET" action="<?php echo e($en ? route('english.careers') : route('careers')); ?>" style="display:contents;">
        <select name="dept" class="filter-select" onchange="this.form.submit()">
            ...
            <option value="<?php echo e($d); ?>" <?php echo e(request('dept') === $d ? 'selected' : ''); ?>><?php echo e($d); ?></option>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </select>

        <select name="type" class="filter-select" onchange="this.form.submit()">
            <option value=""><?php echo e(__('site.careers_filter_type', [], $loc)); ?></option>
            <?php $__currentLoopData = $contractTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ct): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <option value="<?php echo e($ct); ?>" <?php echo e(request('type') === $ct ? 'selected' : ''); ?>><?php echo e($ct); ?></option>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </select>

        <select name="level" class="filter-select" onchange="this.form.submit()">
            <option value=""><?php echo e(__('site.careers_filter_level', [], $loc)); ?></option>
            ...
            <option value="<?php echo e($key); ?>" <?php echo e(request('level') === $key ? 'selected' : ''); ?>>
                <?php echo e($en ? $labels['en'] : $labels['fr']); ?>
    ...
    <div class="filter-count">
        <span><?php echo e($countLabel); ?></span>
    </div>
</div>
...
<main>
    <div class="jobs-section">
        ...
        <div class="empty-state">
            <div class="icon">💼</div>
            <h3><?php echo e(__('site.careers_empty_h3', [], $loc)); ?></h3>
            <p><?php echo e(__('site.careers_empty_p', [], $loc)); ?></p>
        </div>
        <?php else: ?>
        <div class="jobs-list">
            ...
            <article class="job-card">
                <div class="job-left">
                    <div class="job-dept-row">
                        <span class="job-dept-tag"><?php echo e($job->department); ?></span>
                        <?php if($isUrgent): ?>
                            <span class="job-urgent"><?php echo e($daysLeft === 0 ? __('site.careers_alert_urgent', [], $loc) : str_replace(':n', $daysLeft, __('site.careers_alert_deadline', [], $loc))); ?></span>
                        <?php endif; ?>
                    </div>
                    <h3><a href="<?php echo e($detailRoute); ?>" style="color:inherit;"><?php echo e($job->title); ?></a></h3>
                    <?php if($job->description): ?>
                        <p class="job-excerpt"><?php echo e(Str::limit($job->description, 160)); ?></p>
                    <?php endif; ?>
                    <div class="job-badges">
                        <span class="badge b-type"><?php echo e($job->contract_type); ?></span>
                        <span class="badge b-loc">📍 <?php echo e($job->location); ?></span>
                        <?php if($job->experience_level): ?>
                            <span class="badge b-level"><?php echo e($en ? $job->experienceLabelEn() : $job->experienceLabelFr()); ?></span>
                        <?php endif; ?>
                        <?php if($job->salary_range): ?>
                            <span class="badge b-salary"><?php echo e($job->salary_range); ?></span>
                        <?php endif; ?>
                    </div>
                    <?php if($job->deadline): ?>
                        <div class="job-deadline">
                            <span>🗓</span>
                            <span class="<?php echo e($isUrgent ? 'soon' : ''); ?>">
                                <?php echo e(__('site.careers_deadline', [], $loc)); ?>

                                <?php echo e($job->deadline->translatedFormat('d M Y')); ?>
                ...
                <div class="job-right">
                    <a class="btn-apply" href="<?php echo e($detailRoute); ?>">
                        <?php echo e(__('site.careers_apply', [], $loc)); ?> →
                    </a>
                    <a class="btn-see" href="<?php echo e($detailRoute); ?>">
                        <?php echo e(__('site.careers_see_offer', [], $loc)); ?>
        ...
        <div class="spontaneous-band">
            <div>
                <h3><?php echo e(__('site.careers_spontaneous_title', [], $loc)); ?></h3>
                <p><?php echo e(__('site.careers_spontaneous_lead', [], $loc)); ?></p>
            </div>
            <a class="btn-gold"
               href="<?php echo e($en ? route('english.spontaneous') : route('spontaneous')); ?>">
                <?php echo e(__('site.careers_spontaneous_btn', [], $loc)); ?>
...
<?php /**PATH C:\Users\erwan\OneDrive\Bureau\REFONTESITE\resources\views/careers/index.blade.php ENDPATH**/ ?>