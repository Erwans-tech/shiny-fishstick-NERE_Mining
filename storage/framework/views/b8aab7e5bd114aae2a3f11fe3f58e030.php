...
<div class="box">
    ...
    <form method="POST" action="<?php echo e(route('admin.login.alt.post')); ?>">
        <label for="email">Adresse e-mail</label>
        <input id="email" type="email" name="email"
               value="<?php echo e(old('email', 'admin@nere-mining.com')); ?>"
               required autofocus>
...
unset($__errorArgs, $__bag); ?>
    ...
    <div style="text-align:center; margin-top:15px;">
        <a href="<?php echo e(route('admin.diagnostic')); ?>">🔍 Voir diagnostic système</a> |
        <a href="<?php echo e(route('admin.login')); ?>">🔒 Login normal</a>
    </div>

    <div class="debug-info">
        <strong>Debug Info:</strong><br>
        Session Driver: <?php echo e(config('session.driver')); ?><br>
        App Env: <?php echo e(config('app.env')); ?><br>
        App Key Set: <?php echo e(config('app.key') ? 'Oui' : 'Non'); ?><br>
...
</html><?php /**PATH C:\Users\erwan\OneDrive\Bureau\REFONTESITE\resources\views\admin\login-alt.blade.php ENDPATH**/ ?>