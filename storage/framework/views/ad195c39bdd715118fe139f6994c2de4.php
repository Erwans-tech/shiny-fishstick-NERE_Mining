...
<section id="exploitation" class="sand">
    ...
    <div class="grid-2">
        <div class="card karma-production-card karma-production-card--open-pit"><img class="card-img" src="<?php echo e(asset('images/mining/open-pit-mining.jpg')); ?>" alt="<?php echo e($en ? 'Open-pit mining' : 'Extraction à ciel ouvert'); ?>"><h3><?php echo e(__('site.karma_card1_h3', [], $loc)); ?></h3><p><?php echo e(__('site.karma_card1_p', [], $loc)); ?></p></div>
        <div class="card karma-production-card karma-production-card--processing"><img class="card-img" src="<?php echo e(asset('images/mining/gold-extraction-plant.jpg')); ?>" alt="<?php echo e($en ? 'Gold processing plant' : 'Usine de traitement de l’or'); ?>"><h3><?php echo e(__('site.karma_card2_h3', [], $loc)); ?></h3><p><?php echo e(__('site.karma_card2_p', [], $loc)); ?></p></div>
    </div>
</section>
</div>
