    ...
    <div class="grid-2">
        <div>
            ...
            <ul style="list-style:none; padding:0; margin:16px 0; font-size:15px; line-height:1.8;">
                <li style="margin-bottom:12px; padding-left:24px; position:relative;">
                    ...
                    <?php echo e($en ? 'Respect for the customs and traditions of communities' : 'Le respect des us et coutumes des communautés'); ?>

                </li>
                <li style="padding-left:24px; position:relative;">
                    <span style="position:absolute; left:0; color:var(--gold);">✓</span>
                    <?php echo e($en ? 'Permanent dialogue: regular consultations with all stakeholders (customary, religious and administrative authorities, economic actors, civil society actors, artisanal miners)' : 'Le dialogue permanent : concertations régulières avec l\'ensemble des parties prenantes (autorités coutumières et religieuses et administratives, économiques, acteurs de la société civile artisans miniers)'); ?>
            ...
            <div class="card" style="background:var(--sand); border:1px solid var(--line); margin-top:24px;">
                <h4 style="color:var(--green); margin-bottom:12px;"><?php echo e($en ? 'Geographic Impact' : 'Impact Géographique'); ?></h4>
                <p>
                    <?php echo e($en 
        ...
        <div>
            ...
            <div class="card" style="background:#fff; border:1px solid var(--line); margin-top:24px;">
                ...
                <p style="margin-bottom:12px;"><?php echo e($en ? 'Our interventions focus on:' : 'Les interventions de la mine prennent en compte :'); ?></p>
                <ul style="list-style:none; padding:0; margin:0; font-size:14px; line-height:1.8;">
                    <li style="padding-left:20px; position:relative; margin-bottom:8px;">
                        <span style="position:absolute; left:0;">🎓</span> <?php echo e($en ? 'Education' : 'Éducation'); ?>

                    </li>
                    <li style="padding-left:20px; position:relative; margin-bottom:8px;">
                        <span style="position:absolute; left:0;">🏥</span> <?php echo e($en ? 'Health' : 'Santé'); ?>

                    </li>
                    <li style="padding-left:20px; position:relative; margin-bottom:8px;">
                        <span style="position:absolute; left:0;">💧</span> <?php echo e($en ? 'Access to potable water' : 'Accès à l\'eau potable'); ?>

                    </li>
                    <li style="padding-left:20px; position:relative; margin-bottom:8px;">
                        <span style="position:absolute; left:0;">👩</span> <?php echo e($en ? 'Women\'s empowerment' : 'Autonomisation des femmes'); ?>

                    </li>
                    <li style="padding-left:20px; position:relative;">
                        <span style="position:absolute; left:0;">👨‍💼</span> <?php echo e($en ? 'Youth employability' : 'Employabilité des jeunes'); ?>
...
<section class="sand" style="padding:60px 5vw;">
    <div style="max-width:1180px; margin:0 auto;">
        <h2 style="text-align:center; color:var(--green); margin-bottom:12px; font-size:36px; font-weight:600;"><?php echo e($en ? 'Main Achievements 2014-2025' : 'Principales Réalisations 2014-2025'); ?></h2>
        ...
        <div style="display:grid; grid-template-columns:repeat(auto-fit, minmax(280px, 1fr)); gap:24px;">
            ...
            <div style="background:#fff; padding:32px; border-radius:12px; border:1px solid var(--line);">
                ...
                <h3 style="color:var(--green); font-size:20px; margin-bottom:16px;"><?php echo e($en ? 'Education' : 'Éducation'); ?></h3>
                <div style="font-size:28px; font-weight:700; color:var(--gold); margin-bottom:12px;"><?php echo e($en ? 'Nearly 150M FCFA' : 'Près de 150M FCFA'); ?></div>
                <ul style="list-style:none; padding:0; margin:0; font-size:14px; line-height:1.8; color:var(--muted);">
                    <li style="margin-bottom:8px;">• <?php echo e($en ? 'Construction and rehabilitation of schools' : 'Construction et réhabilitation d\'écoles'); ?></li>
                    <li style="margin-bottom:8px;">• <?php echo e($en ? 'Solar electrification' : 'Électrification solaire'); ?></li>
                    <li style="margin-bottom:8px;">• <?php echo e($en ? 'Provision of school furniture' : 'Dotation en mobilier scolaire'); ?></li>
                    <li style="margin-bottom:8px;">• <?php echo e($en ? 'Promotion of excellence' : 'Promotion de l\'excellence'); ?></li>
                    <li>• <?php echo e($en ? 'Improvement of learning conditions' : 'Amélioration des conditions d\'apprentissage'); ?></li>
                </ul>
            </div>
            ...
            <div style="background:#fff; padding:32px; border-radius:12px; border:1px solid var(--line);">
                <div style="font-size:24px; margin-bottom:12px;">🏥</div>
                <h3 style="color:var(--green); font-size:20px; margin-bottom:16px;"><?php echo e($en ? 'Health' : 'Santé'); ?></h3>
                <div style="font-size:28px; font-weight:700; color:var(--gold); margin-bottom:12px;"><?php echo e($en ? 'More than 160M FCFA' : 'Plus de 160M FCFA'); ?></div>
                <ul style="list-style:none; padding:0; margin:0; font-size:14px; line-height:1.8; color:var(--muted);">
                    <li style="margin-bottom:8px;">• <?php echo e($en ? 'Construction and equipment of Namissiguima CSPS' : 'Construction et équipement du CSPS de Namissiguima'); ?></li>
                    <li style="margin-bottom:8px;">• <?php echo e($en ? 'Provision of ambulances' : 'Mise à disposition d\'ambulances'); ?></li>
                    <li>• <?php echo e($en ? 'Rehabilitation of Kononga CSPS' : 'Réhabilitation du CSPS de Kononga'); ?></li>
                </ul>
            </div>
            ...
            <div style="background:#fff; padding:32px; border-radius:12px; border:1px solid var(--line);">
                <div style="font-size:24px; margin-bottom:12px;">💧</div>
                <h3 style="color:var(--green); font-size:20px; margin-bottom:16px;"><?php echo e($en ? 'Access to Water' : 'Accès à l\'Eau'); ?></h3>
                <div style="font-size:28px; font-weight:700; color:var(--gold); margin-bottom:12px;"><?php echo e($en ? 'More than 240M FCFA' : 'Plus de 240M FCFA'); ?></div>
                <ul style="list-style:none; padding:0; margin:0; font-size:14px; line-height:1.8; color:var(--muted);">
                    <li style="margin-bottom:8px;">• <?php echo e($en ? 'Construction of wells and boreholes' : 'Réalisation de puits et forages'); ?></li>
                    <li style="margin-bottom:8px;">• <?php echo e($en ? 'Pastoral boreholes' : 'Forages pastoraux'); ?></li>
                    <li style="margin-bottom:8px;">• <?php echo e($en ? 'Water reservoirs' : 'Retenues d\'eau'); ?></li>
                    <li>• <?php echo e($en ? 'Water towers and potable water supply systems' : 'Châteaux d\'eau et systèmes d\'adduction d\'eau potable'); ?></li>
                </ul>
            </div>
            ...
            <div style="background:#fff; padding:32px; border-radius:12px; border:1px solid var(--line);">
                <div style="font-size:24px; margin-bottom:12px;">🌾</div>
                <h3 style="color:var(--green); font-size:20px; margin-bottom:16px;"><?php echo e($en ? 'Livelihoods & Economic Development' : 'Moyens de Subsistance & Développement Économique'); ?></h3>
                <div style="font-size:28px; font-weight:700; color:var(--gold); margin-bottom:12px;"><?php echo e($en ? 'More than 350M FCFA' : 'Plus de 350M FCFA'); ?></div>
                <ul style="list-style:none; padding:0; margin:0; font-size:14px; line-height:1.8; color:var(--muted);">
                    <li style="margin-bottom:8px;">• <?php echo e($en ? 'Support to Project Affected Persons (PAP)' : 'Appui aux Personnes Affectées par le Projet (PAP)'); ?></li>
                    <li style="margin-bottom:8px;">• <?php echo e($en ? 'Agricultural inputs' : 'Intrants agricoles'); ?></li>
                    <li style="margin-bottom:8px;">• <?php echo e($en ? 'Professional training' : 'Formations professionnelles'); ?></li>
                    <li style="margin-bottom:8px;">• <?php echo e($en ? 'Market gardening and livestock farming' : 'Maraîchage et élevage'); ?></li>
                    <li>• <?php echo e($en ? 'Income generating activities' : 'Activités génératrices de revenus'); ?></li>
                </ul>
            </div>
            ...
            <div style="background:#fff; padding:32px; border-radius:12px; border:1px solid var(--line);">
                ...
                <h3 style="color:var(--green); font-size:20px; margin-bottom:16px;"><?php echo e($en ? 'Infrastructure & Accessibility' : 'Infrastructures & Désenclavement'); ?></h3>
                <div style="font-size:28px; font-weight:700; color:var(--gold); margin-bottom:12px;"><?php echo e($en ? 'More than 519M FCFA' : 'Plus de 519M FCFA'); ?></div>
                <ul style="list-style:none; padding:0; margin:0; font-size:14px; line-height:1.8; color:var(--muted);">
                    <li style="margin-bottom:8px;">• <?php echo e($en ? 'Flagship project: paving of 7.5 km of RD149 road' : 'Réalisation phare : bitumage de 7,5 km de la RD149'); ?></li>
                    <li style="margin-bottom:8px;">• <?php echo e($en ? 'Associated sanitation works' : 'Travaux d\'assainissement associés'); ?></li>
                    <li>• <?php echo e($en ? 'Significant improvement in mobility and reduction of dust nuisances' : 'Forte amélioration de la mobilité et réduction des nuisances de poussière'); ?></li>
                </ul>
            </div>
        </div>
        ...
        <div style="margin-top:48px; text-align:center; padding:32px; background:linear-gradient(135deg, #4B1716 0%, #281D18 100%); border-radius:12px; color:#fff;">
            <div style="font-size:14px; text-transform:uppercase; letter-spacing:0.1em; margin-bottom:12px; opacity:0.8;"><?php echo e($en ? 'Total Community Investment 2014-2025' : 'Investissement Communautaire Total 2014-2025'); ?></div>
            <div style="font-size:48px; font-weight:700; color:var(--gold);">1.419 <?php echo e($en ? 'Billion' : 'Milliard'); ?> FCFA</div>
        </div>
    </div>
</section>
...
<section class="sand">
    <h2 style="text-align:center; color:var(--green); margin-bottom:20px; font-size:32px;"><?php echo e($en ? 'Grievance and Conflict Management' : 'Mécanisme de Gestion des Plaintes et des Conflits'); ?></h2>
    <p class="lead">
        <?php echo e($en 
