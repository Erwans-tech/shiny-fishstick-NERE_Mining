...
<?php $__env->stopPush(); ?>
    ...
    <div class="leadership-section">
        <div class="leadership-intro">
            ...
            <p><?php echo e($en ? 'Meet the leaders who guide RIVERSTONE KARMA and its commitments to the territory.' : 'Découvrez les dirigeants qui portent la vision de RIVERSTONE KARMA et ses engagements pour le territoire.'); ?></p>
        </div>
        ...
        <section class="leadership-level" aria-labelledby="leadership-level-<?php echo e($level); ?>">
            <?php if(!empty($levelLabels[$level] ?? $levelLabels[3])): ?>
