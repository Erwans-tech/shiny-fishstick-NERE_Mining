...
<body class="<?php echo e($isSustain ? 'is-sustain' : ''); ?>">
    ...
    <script defer src="<?php echo e(asset('js/animations.js')); ?>"></script>
    <script defer src="<?php echo e(asset('js/page-animations.js')); ?>?v=<?php echo e(filemtime(public_path('js/page-animations.js'))); ?>"></script>
