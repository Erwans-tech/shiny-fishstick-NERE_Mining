...
<head>
    ...
    <style>
        ...
        *{box-sizing:border-box;margin:0;padding:0;}
        ...
        .masthead{padding:100px 5vw 80px;color:white;background:linear-gradient(100deg,rgba(75,23,22,.96) 45%,rgba(75,23,22,.55)),url('<?php echo e(asset('images/mining/karma-05.jpg')); ?>') center/cover;}
...
<body>
    <?php echo $__env->make('partials._nav', ['locale' => $locale ?? 'fr', 'section' => 'reports'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    ...
    <main>
        <section>
            ...
            <div class="grid-3">
                ...
                <article class="card">
                    <div class="card-tag"><?php echo e($report->category); ?></div>
                    <h3><?php echo e($report->title); ?></h3>
                    <?php if($report->description): ?><p><?php echo e($report->description); ?></p><?php endif; ?>
                    <?php if($report->published_at): ?>
                        <p style="font:600 11px Inter,sans-serif; color:var(--gold); text-transform:uppercase; letter-spacing:.08em; margin-bottom:0;">
                            <?php echo e($report->published_at->translatedFormat('Y')); ?>

                        </p>
                    <?php endif; ?>
                    <a class="btn <?php echo e($report->file_path ? 'btn-gold' : 'disabled'); ?>"
                       href="<?php echo e($report->file_path ? asset($report->file_path) : '#'); ?>"
                       <?php echo e($report->file_path ? 'target=_blank' : ''); ?>>
                        <?php echo e($report->file_path ? __('site.download_pdf') : __('site.coming_soon')); ?>

                    </a>
                </article>
                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                <p class="lead" style="grid-column:span 3;"><?php echo e(__('site.reports_empty')); ?></p>
                <?php endif; ?>
            </div>
        </section>
    </main>
...
<?php /**PATH C:\Users\erwan\OneDrive\Bureau\REFONTESITE\resources\views\reports\index.blade.php ENDPATH**/ ?>