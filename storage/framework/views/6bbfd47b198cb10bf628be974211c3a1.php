...
<head>
    ...
    <title><?php echo e($album->title); ?> | Néré Mining</title>
    <meta name="description" content="<?php echo e(Str::limit($album->description, 155)); ?>">
    ...
    <style>
        ...
        * { box-sizing:border-box; margin:0; padding:0; }
        ...
        /* ── Masthead ── */
        .masthead { padding:80px 5vw 60px; color:white; background:linear-gradient(100deg,rgba(75,23,22,.96) 45%,rgba(75,23,22,.55)),url('<?php echo e($album->cover_url ?? asset('images/mining/karma-02.jpg')); ?>') center/cover; }
...
<?php echo $__env->make('partials._nav', ['section' => 'gallery'], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>

<div class="masthead">
    <div class="eyebrow"><?php echo e($en ? 'Photo Album' : 'Album Photo'); ?></div>
    <h1><?php echo e($album->title); ?></h1>
    <?php if($album->description): ?>
        <p class="lead"><?php echo e($album->description); ?></p>
    <?php endif; ?>
</div>

<main>
    <div class="breadcrumb">
        <a href="<?php echo e($en ? route('english') : route('home')); ?>"><?php echo e($en ? 'Home' : 'Accueil'); ?></a> / 
        <a href="<?php echo e($en ? route('english.gallery') : route('gallery')); ?>"><?php echo e($en ? 'Media' : 'Médiathèque'); ?></a> / 
    ...
    <div class="album-header">
        <div class="album-meta-info">
            <span>
                ...
                <?php echo e($album->publishedMedia->count()); ?> <?php echo e($album->publishedMedia->count() > 1 ? ($en ? 'photos' : 'photos') : ($en ? 'photo' : 'photo')); ?>
            ...
            <span>
                ...
                <?php echo e($album->created_at->isoFormat('D MMMM YYYY')); ?>

            </span>
        </div>
    </div>

    <?php if($album->publishedMedia->isEmpty()): ?>
        <div style="text-align:center;padding:80px 20px;color:var(--muted);">
            <div style="font-size:64px;margin-bottom:16px;">📸</div>
            <h2 style="font-size:24px;margin-bottom:12px;"><?php echo e($en ? 'No photos yet' : 'Aucune photo pour le moment'); ?></h2>
            <p><?php echo e($en ? 'This album is empty.' : 'Cet album est vide.'); ?></p>
        </div>
    <?php else: ?>
        <div class="photo-grid">
            <?php $__currentLoopData = $album->publishedMedia; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $media): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="photo-item" data-lightbox-trigger data-img-src="<?php echo e($media->url); ?>" data-img-caption="<?php echo e($media->caption ?? $media->title); ?>">
                    <img src="<?php echo e($media->url); ?>" alt="<?php echo e($media->title); ?>" class="photo-img" loading="lazy">
                    <?php if($media->caption): ?>
                        <div class="photo-caption"><?php echo e($media->caption); ?></div>
                    <?php endif; ?>
                </div>
...
<?php echo $__env->make('partials._footer', ['locale' => $locale], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php /**PATH C:\Users\erwan\OneDrive\Bureau\REFONTESITE\resources\views\gallery\album.blade.php ENDPATH**/ ?>