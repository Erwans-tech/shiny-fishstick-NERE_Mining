    ...
    <div style="max-width:980px; margin:0 auto; padding:40px 0 20px;">
        <div style="margin-bottom:24px;">
            ...
            <h1 style="margin-top:18px; font-size:clamp(30px,4vw,52px); line-height:1.1; color:#281d18; letter-spacing:-.04em;">
                <?php echo e($en ? 'Privacy policy' : 'Politique de confidentialité'); ?>
        ...
        <div style="background:rgba(255,255,255,.82); border:1px solid rgba(234,220,197,.8); border-radius:18px; padding:28px 24px; box-shadow:0 10px 24px rgba(0,0,0,.04);">
            <p>
                <?php echo e($en ? 'This privacy policy explains how Néré Mining collects, uses and protects information on this website.' : 'Cette politique de confidentialité explique comment Néré Mining collecte, utilise et protège les informations sur ce site web.'); ?>

            </p>

            <h2 style="font-size:1.4rem; color:#4b1716; margin:26px 0 12px;">1. Information collected</h2>
            <p>
                <?php echo e($en ? 'We may collect information such as your email address, the content of your contact or application forms, technical information such as your browser and IP address, and navigation data for site operation and statistics.' : 'Nous pouvons collecter des informations telles que votre adresse e-mail, le contenu de vos formulaires de contact ou de candidature, des informations techniques telles que votre navigateur et votre adresse IP, ainsi que des données de navigation pour le fonctionnement du site et les statistiques.'); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\erwan\OneDrive\Bureau\REFONTESITE\resources\views\legal\privacy-policy.blade.php ENDPATH**/ ?>