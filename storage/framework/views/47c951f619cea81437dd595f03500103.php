...
<section id="exploration" class="sa-animated-section" style="padding-top:40px;">
    ...
    <div class="sa-section-heading sa-reveal" style="text-align:left; max-width:none; margin-bottom:24px;">
        <h2 style="text-align:left;"><?php echo e(__('site.projects_expl_h2', [], $loc)); ?></h2>
        <div class="sa-divider" style="margin: 0;"></div>
    </div>
    <p class="lead sa-reveal sa-delay-1"><?php echo e(__('site.projects_expl_lead', [], $loc)); ?></p>

    <div class="projects-grid" style="margin-top:32px;">
        <article class="card project-card exploration-card sa-reveal sa-delay-1">
            <button class="exploration-card__image" type="button" data-exploration-image="<?php echo e(asset('images/exploration/geologie-dassoui.png')); ?>" data-exploration-alt="<?php echo e($en ? 'Dassoui exploration permit and regional geology map' : 'Carte géologique régionale du permis d’exploration de Dassoui'); ?>" data-exploration-caption="<?php echo e($en ? 'Regional geology and Dassoui exploration permit.' : 'Géologie régionale et permis d’exploration de Dassoui.'); ?>"><img src="<?php echo e(asset('images/exploration/geologie-dassoui.png')); ?>" alt="<?php echo e($en ? 'Dassoui exploration permit and regional geology map' : 'Carte géologique régionale du permis d’exploration de Dassoui'); ?>" loading="lazy"></button>
            <div class="exploration-card__body">
                <div class="card-tag"><?php echo e($en ? 'Dassoui permit' : 'Permis de Dassoui'); ?></div>
                <h3><?php echo e($en ? 'Regional geological exploration' : 'Exploration géologique régionale'); ?></h3>
                ...
                <div class="exploration-card__meta"><span><strong><?php echo e($en ? 'Focus:' : 'Objectif :'); ?></strong> <?php echo e($en ? 'regional targets and structures' : 'cibles et structures régionales'); ?></span><span><strong><?php echo e($en ? 'Method:' : 'Méthode :'); ?></strong> <?php echo e($en ? 'geological mapping' : 'cartographie géologique'); ?></span></div>
            </div>
        </article>

        <article class="card project-card exploration-card sa-reveal sa-delay-2">
            <button class="exploration-card__image" type="button" data-exploration-image="<?php echo e(asset('images/exploration/forage.jpg')); ?>" data-exploration-alt="<?php echo e($en ? 'Reverse circulation drilling rig' : 'Foreuse de reconnaissance minière'); ?>" data-exploration-caption="<?php echo e($en ? 'Drilling and sampling campaign in the field.' : 'Campagne de forage et d’échantillonnage sur le terrain.'); ?>"><img src="<?php echo e(asset('images/exploration/forage.jpg')); ?>" alt="<?php echo e($en ? 'Reverse circulation drilling rig' : 'Foreuse de reconnaissance minière'); ?>" loading="lazy"></button>
            <div class="exploration-card__body">
                <div class="card-tag"><?php echo e($en ? 'Field program' : 'Programme terrain'); ?></div>
                <h3><?php echo e($en ? 'Drilling and target verification' : 'Forage et vérification des cibles'); ?></h3>
                <p><?php echo e($en ? 'Exploration moves from the map to the field through drilling, sampling and geological logging. These activities test the continuity, geometry and grade potential of anomalies before any resource estimate is considered.' : 'L’exploration passe de la carte au terrain par le forage, l’échantillonnage et la description géologique. Ces travaux testent la continuité, la géométrie et le potentiel des anomalies avant toute estimation de ressources.'); ?></p>
                <div class="exploration-card__meta"><span><strong><?php echo e($en ? 'Focus:' : 'Objectif :'); ?></strong> <?php echo e($en ? 'subsurface confirmation' : 'confirmation en profondeur'); ?></span><span><strong><?php echo e($en ? 'Work:' : 'Travaux :'); ?></strong> <?php echo e($en ? 'drilling and sampling' : 'forage et échantillonnage'); ?></span></div>
            </div>
        </article>

        <article class="card project-card exploration-card exploration-card--map sa-reveal sa-delay-3">
            <button class="exploration-card__image" type="button" data-exploration-image="<?php echo e(asset('images/exploration/permis-carte.jpg')); ?>" data-exploration-alt="<?php echo e($en ? 'Exploration permits and mineral targets map' : 'Carte des permis d’exploration et des cibles minérales'); ?>" data-exploration-caption="<?php echo e($en ? 'Exploration permits, targets and licence coverage.' : 'Permis d’exploration, cibles et couverture des titres.'); ?>"><img src="<?php echo e(asset('images/exploration/permis-carte.jpg')); ?>" alt="<?php echo e($en ? 'Exploration permits and mineral targets map' : 'Carte des permis d’exploration et des cibles minérales'); ?>" loading="lazy"></button>
            <div class="exploration-card__body">
                <div class="card-tag"><?php echo e($en ? 'Portfolio' : 'Portefeuille'); ?></div>
                <h3><?php echo e($en ? 'A connected exploration portfolio' : 'Un portefeuille d’exploration connecté'); ?></h3>
                ...
                <div class="exploration-card__meta"><span><strong><?php echo e($en ? 'Focus:' : 'Objectif :'); ?></strong> <?php echo e($en ? 'licence and target coverage' : 'couverture des titres et cibles'); ?></span><span><strong><?php echo e($en ? 'Tool:' : 'Support :'); ?></strong> <?php echo e($en ? 'permit mapping' : 'cartographie des permis'); ?></span></div>
            </div>
        </article>
    </div>

    <div class="exploration-evidence" aria-label="<?php echo e($en ? 'Exploration field evidence' : 'Documents visuels de l’exploration'); ?>">
        <figure class="sa-reveal sa-delay-1">
            <button type="button" data-exploration-image="<?php echo e(asset('images/exploration/panorama-goulagou.png')); ?>" data-exploration-alt="<?php echo e($en ? 'Annotated 180 degree view from Goulagou Hill' : 'Vue panoramique annotée depuis la colline de Goulagou'); ?>" data-exploration-caption="<?php echo e($en ? 'Annotated Goulagou Hill panorama.' : 'Panorama annoté depuis la colline de Goulagou.'); ?>"><img src="<?php echo e(asset('images/exploration/panorama-goulagou.png')); ?>" alt="<?php echo e($en ? 'Annotated 180 degree view from Goulagou Hill' : 'Vue panoramique annotée depuis la colline de Goulagou'); ?>" loading="lazy"></button>
            <figcaption><?php echo e($en ? 'Goulagou Hill panorama: the annotated horizon places GG1, Nami, Rambo, GG2 and Kao within the exploration landscape.' : 'Panorama de la colline de Goulagou : l’horizon annoté situe GG1, Nami, Rambo, GG2 et Kao dans le paysage d’exploration.'); ?></figcaption>
        </figure>
        <figure class="sa-reveal sa-delay-2">
            <button type="button" data-exploration-image="<?php echo e(asset('images/exploration/equipe-instrumentation.jpg')); ?>" data-exploration-alt="<?php echo e($en ? 'Exploration team working with technical equipment' : 'Équipe d’exploration travaillant avec un équipement technique'); ?>" data-exploration-caption="<?php echo e($en ? 'Field team and technical instrumentation.' : 'Équipe terrain et instrumentation technique.'); ?>"><img src="<?php echo e(asset('images/exploration/equipe-instrumentation.jpg')); ?>" alt="<?php echo e($en ? 'Exploration team working with technical equipment' : 'Équipe d’exploration travaillant avec un équipement technique'); ?>" loading="lazy"></button>
            <figcaption><?php echo e($en ? 'Field teams and technical instrumentation support data collection and target assessment.' : 'Les équipes et l’instrumentation terrain soutiennent la collecte des données et l’évaluation des cibles.'); ?></figcaption>
        </figure>
        <figure class="sa-reveal sa-delay-3">
            <button type="button" data-exploration-image="<?php echo e(asset('images/exploration/permis-tableau.png')); ?>" data-exploration-alt="<?php echo e($en ? 'Exploration permits validity table' : 'Tableau de validité des permis d’exploration'); ?>" data-exploration-caption="<?php echo e($en ? 'Exploration permit register and validity dates.' : 'Registre des permis d’exploration et dates de validité.'); ?>"><img src="<?php echo e(asset('images/exploration/permis-tableau.png')); ?>" alt="<?php echo e($en ? 'Exploration permits validity table' : 'Tableau de validité des permis d’exploration'); ?>" loading="lazy"></button>
            <figcaption><?php echo e($en ? 'Permit register: Dassoui, Basnere Est and Ouest, Lougouri, Ronga, Rigui and Zanna are shown with their holders and validity years.' : 'Registre des permis : Dassoui, Basnere Est et Ouest, Lougouri, Ronga, Rigui et Zanna sont présentés avec leurs détenteurs et années de validité.'); ?></figcaption>
        </figure>
    </div>
</section>
...
<div class="exploration-lightbox" data-exploration-lightbox aria-hidden="true">
    <figure class="exploration-lightbox__dialog">
        <button class="exploration-lightbox__close" type="button" data-exploration-close><?php echo e($en ? 'Close' : 'Fermer'); ?></button>
