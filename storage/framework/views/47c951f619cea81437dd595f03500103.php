...
<section id="exploration" class="sa-animated-section" style="padding-top:40px;">
    ...
    <div class="projects-grid" style="margin-top:32px;">
        ...
        <article class="card project-card exploration-card sa-reveal sa-delay-2">
            <button class="exploration-card__image" type="button" data-exploration-image="<?php echo e(asset('images/mining/mining-site-aerial-01.jpg')); ?>" data-exploration-alt="<?php echo e($en ? 'Mine site aerial view' : 'Vue aérienne du site minier'); ?>" data-exploration-caption="<?php echo e($en ? 'Mine operation area and infrastructure.' : 'Zone d’exploitation minière et infrastructures.'); ?>"><img src="<?php echo e(asset('images/mining/mining-site-aerial-01.jpg')); ?>" alt="<?php echo e($en ? 'Mine site aerial view' : 'Vue aérienne du site minier'); ?>" loading="lazy"></button>
            <div class="exploration-card__body">
                <div class="card-tag"><?php echo e($en ? 'Field program' : 'Programme terrain'); ?></div>
                <h3><?php echo e($en ? 'Mine site and field operations' : 'Site minier et opérations terrain'); ?></h3>
