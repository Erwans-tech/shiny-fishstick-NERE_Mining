...
<head>
    ...
    <style>
        ...
        *{box-sizing:border-box;margin:0;padding:0;}
        ...
        .masthead{padding:100px 5vw 80px;color:white;background:linear-gradient(100deg,rgba(75,23,22,.96) 45%,rgba(75,23,22,.55)),url('<?php echo e(asset('images/mining/karma-01.jpg')); ?>') center/cover;}
...
<?php /**PATH C:\Users\erwan\OneDrive\Bureau\REFONTESITE\resources\views/news/index.blade.php ENDPATH**/ ?>