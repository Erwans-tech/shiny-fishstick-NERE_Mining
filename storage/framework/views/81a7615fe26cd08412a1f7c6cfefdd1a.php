            ...
            <ul style="list-style:none; display:flex; flex-direction:column; gap:14px;">
                <li style="display:flex; gap:14px; align-items:center;">
                    ...
                    <div>
                        ...
                        <span style="color:#fff; font:15px Inter,sans-serif;"><?php echo e($pressPhone); ?></span>
                    </div>
                </li>
                <li style="display:flex; gap:14px; align-items:center;">
                ...
                <li style="display:flex; gap:14px; align-items:center;">
                    ...
                    <div>
                        ...
                        <span style="color:#fff; font:15px Inter,sans-serif;"><?php echo e($pressHours); ?></span>
                    </div>
                </li>
            </ul>
        </div>
...
<section class="sand press-form-section">
    ...
    <form class="press-form" method="POST" action="<?php echo e($en ? route('english.contact.store') : route('contact.store')); ?>">
        <?php echo csrf_field(); ?>
        ...
        <button class="press-form-submit" type="submit"><?php echo e(__('site.send_request', [], $loc)); ?></button>
    </form>
    </div>
</section>
