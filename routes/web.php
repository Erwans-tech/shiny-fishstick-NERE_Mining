...
Route::get('/ressources',                   fn() => redirect()->route('karma.resources'))->name('resources');
Route::get('/reserves',                     fn() => redirect()->route('karma.resources'))->name('reserves');
Route::get('/karma/ressources-reserves',    fn() => $page('fr', 'karma-resources-reserves'))->name('karma.resources');
...
Route::get('/en/resources',           fn() => redirect()->route('english.karma.resources'))->name('english.resources');
Route::get('/en/reserves',             fn() => redirect()->route('english.karma.resources'))->name('english.reserves');
Route::get('/en/karma/resources-reserves', fn() => $page('en', 'karma-resources-reserves'))->name('english.karma.resources');
...
Route::prefix('gestion-nm')->name('admin.')->group(function () {
    ...
    Route::middleware('admin.auth')->group(function () {
        ...
        Route::delete('/media/bulk-delete',   [AdminMediaController::class, 'bulkDelete'])->name('media.bulk.delete');
